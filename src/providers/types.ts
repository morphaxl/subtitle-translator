...
export const PROVIDERS: Record<ProviderName, ProviderInfo> = {
  openai: {
    name: 'openai',
    displayName: 'OpenAI',
    description: 'gpt-4o-mini (default) - fast, cheap, great for translation',
    requiresApiKey: true,
  ...
  anthropic: {
    ...
    description: 'claude-3-5-haiku (default) - fast, cheap, great for translation',
    requiresApiKey: true,
  ...
  gemini: {
    ...
    description: 'gemini-2.0-flash (default) - fast, cheap, great for translation',
    requiresApiKey: true,
